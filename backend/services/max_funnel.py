...
DETAIL_TIPS = (
    "Чем больше деталей — тем индивидуальнее будет подарок.\n"
    "\n"
    "Можно коротко:\n"
    "• Как зовут?\n"
    "• Чем занимается?\n"
    "• Что любите друг в друге?\n"
    "• Важный момент или история?\n"
    "• Что хотите пожелать?\n"
    "\n"
    "Пример:\n"
    "Зовут Маша, любит заниматься танцами. Люблю больше всего в ней, "
    "как она смеется и поддерживает меня. Добавь в песню что мы поженились "
    "15 ноября 2015 года и как мы были счастливы тогда. Хочу пожелать, "
    "чтобы мы оставались всегда счастливы вместе."
)
DETAIL_GIFT = (
